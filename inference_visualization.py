...
def get_args_parser():
    ...
    parser.add_argument('--resume', default='./exps/v002/checkpoint.pth', help='resume from checkpoint')
...
def main(args):
    ...
    print(transforms)
    inference(model, args.inference_img_path, device, transforms, num2char)
...
def inference(model, img_path, device, transforms, num2char):
    model.eval()
    ...
    print(img_cpu.shape)
    model_ver = "v002"
    vslzr.visualize(img_path, img_cpu, pred_dict, savedir=f'./vis/visual_result/{model_ver}', dpi=200)
