...
def get_args_parser():
    ...
    parser.add_argument('--resume', default='./exps/v002-relative_coord-box_refine/checkpoint0015.pth', help='resume from checkpoint')
    ...
    parser.add_argument('--inference_img_path', default='/DATACENTER/raid0/yaowenhao/proj/Deformable-DETR-Synthtext-recog/data/synthtext/SynthText/123/park_112_59.jpg', type=str)
...
def inference(model, img_path, device, transforms, num2char, model_ver):
    ...
    vslzr.visualize(img_path, img_cpu, pred_dict_c, pred_dict_b, pred_dict_p, res_lst, savedir=savedir, dpi=200)
