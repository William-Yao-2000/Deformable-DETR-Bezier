...
def get_args_parser():
    ...
    parser.add_argument('--epochs', default=15, type=int)  # origin: 50
    parser.add_argument('--lr_drop', default=12, type=int)  # origin: 40
...
def main(args):
    ...
    # print(image)
    # print(target)
    # image.save("z-train-image.jpg")
    # torch.save(target['bezier']['points'], "z-train-point.pt")
    # print("\n----------\n")
    # print(dataset_val[0])
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            # extra checkpoint before LR drop and every 3 epochs    origin: 5 epochs
